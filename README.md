...
<img width=18px align=center alt=":bingo-bango:" title=":bingo-bango:" src=https://user-images.githubusercontent.com/886627/165588956-e19d5e3e-c39f-4304-8f9f-a7cdfd077b69.gif> Nice to meet you! I’m a software engineer and design technologist. I build front end systems for the web, specializing in scalable CSS and Javascript architectures for UI development. From print, to pixels, to code, I [cut my teeth][rgd2] working across a range of visual mediums, and collaborating with other talented developers and designers to solve difficult user interface problems at scale. I currently head up the engineering team at 📘 [ReadMe][ReadMe], where we're helping some of the biggest names in tech build their best docs.
